...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = "@r*-t*njmi-vd&m5dcm0&42a%6lek08a*_74z)i!1)vxrk^9rs"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost','jackson.jacksonandalice.com', '127.0.0.1']

# ALLOWED_HOSTS = ['nolimit-jacksonapp.fjyxll.easypanel.host', 'jackson.jacksonandalice.com']
CSRF_TRUSTED_ORIGINS  = ['https://jackson.aliceandjackson.com']
